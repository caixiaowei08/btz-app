...
export class LivePage {
  ...
  vd:any;
  constructor(public modalCtrl:ModalController,public navCtrl: NavController,public navParams: NavParams,private httpstorage:HttpStorage,private transfer: Transfer, private file: File) {
